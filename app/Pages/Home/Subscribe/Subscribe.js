        ...
        <section className="bg-[#111827] py-14 lg:py-28 flex justify-center relative overflow-hidden">
            <div className="subscribe">
                <div className="section-heading text-center">
                    <h4 className="text-base text-yellow-400 font-bold mb-3">Let's Try! Get Free Support</h4>
                    <h2 className="text-4xl font-bold text-white mb-3">Start Your 14-Day Free Trial</h2>
                    <p className="text-[#d9d9d9] text-base mb-3">We can help you to create your dream website for better business revenue.</p>
                </div>
                <div className="subscribe-form flex gap-3 justify-center">
                    <div>
                        <input type="text" className="px-2 py-3 bg-white w-full rounded-lg outline-none" placeholder="Your Email" />
                    </div>
                    <div>
                        <button className="py-3 px-5 text-white bg-[#124acc] hover:bg-[#0044e3] rounded-lg font-bold">Join</button>
                    </div>
                </div>
